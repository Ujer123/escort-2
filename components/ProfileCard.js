  ...
  return (
    ...
    <div className="relative">
      ...
      <div className="pt-2 flex items-center space-x-2">
        <a href={`tel:${data.phone}`} className="bg-pink-500 text-white p-2 rounded-md hover:text-pink-600">
          <PhoneCall className="w-4 h-4" />
        </a>
        <a href={`https://wa.me/${data.phone}`} target="_blank" rel="noopener noreferrer" className="text-white bg-[#26d367] p-2 rounded-md hover:text-pink-600">
